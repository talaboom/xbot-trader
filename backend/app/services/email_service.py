    ...
    resend.Emails.send({
        ...
        <div style="font-family: -apple-system, sans-serif; max-width: 480px; margin: 0 auto; padding: 40px 20px;">
            ...
            <div style="text-align: center;">
                <a href="https://www.xbottrader.ca/dashboard" style="background: #10b981; color: white; padding: 12px 30px; border-radius: 8px; text-decoration: none; font-weight: bold;">Go to Dashboard</a>
            </div>
        </div>
        """,
    })
